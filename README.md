...
![The component bar sitting above the Transform, with one chip per component on the selected object](Documentation~/images/componentDock.png)
...
![A chip clicked in the bar, with the Inspector below showing only that component](Documentation~/images/showComponentsSelected.png)
...
![Right clicking one of several picked chips, showing the menu entries to copy or paste them all at once](Documentation~/images/copyOrPasteMultiComponents.png)
...
[Documentation~/Componentry.md](Documentation~/Componentry.md) explains how each part works and why it behaves the way it does.
